                ...
                {MOCK_CLIENTS.filter((c) => c.status === 'active').slice(0, 15).map((client) => (
                  <SelectItem key={client.id} textValue={client.name}>
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-gray-500">{client.country} - Nivel {client.priceLevel}</span>
                    </div>
                  </SelectItem>
                ))}
              </Select>
                ...
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <span className="font-semibold text-gray-900 dark:text-white">
                      {selectedClient.paymentTerms === 'contado' ? 'Contado' : selectedClient.paymentTerms.replace('credito_', '') + ' días'}
                    </span>
                  </div>
                </div>
              </div>
