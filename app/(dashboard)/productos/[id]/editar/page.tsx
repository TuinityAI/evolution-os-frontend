...
function getInitialFormData(productId: string) {
  ...
  const supplierMatch = MOCK_SUPPLIERS.find(s => s.name === product.supplier);
  return {
    ...
    supplier: supplierMatch?.id || '',
    country: product.country,
    unit: product.unit,
    unitsPerCase: product.unitsPerCase.toString(),
    minimumQty: product.minimumQty.toString(),
    tariffCode: product.tariffCode,
    priceA: product.prices.A.toString(),
    priceB: product.prices.B.toString(),
    priceC: product.prices.C.toString(),
    priceD: product.prices.D.toString(),
    priceE: product.prices.E.toString(),
    costFOB: product.costFOB.toString(),
    costCIF: product.costCIF.toString(),
...
export default function EditarProductoPage() {
  ...
  const [formData, setFormData] = useState(() => getInitialFormData(productId) || {
    description: '',
    brand: '',
    group: '',
    subGroup: '',
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Editar Producto</h1>
            <p className="font-mono text-sm text-gray-500 dark:text-[#888888]">{product.reference}</p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-gray-200 dark:border-[#2a2a2a] bg-white dark:bg-[#141414]">
        <div className="p-6">
          <div className="space-y-6">
            ...
            <div className="border-t border-gray-200 dark:border-[#2a2a2a] pt-6">
              <h3 className="mb-4 text-sm font-medium text-gray-700 dark:text-gray-300">Identificación</h3>
            ...
            {/* Supplier & Unit */}
            <div className="border-t border-gray-200 dark:border-[#2a2a2a] pt-6">
              <h3 className="mb-4 text-sm font-medium text-gray-700 dark:text-gray-300">Proveedor y Unidad</h3>
            ...
            {/* Prices Section */}
            <div className="border-t border-gray-200 dark:border-[#2a2a2a] pt-6">
              <h3 className="mb-4 text-sm font-medium text-gray-700 dark:text-gray-300">Precios por nivel de cliente</h3>
            ...
            {/* Costs Section */}
            <div className="border-t border-gray-200 dark:border-[#2a2a2a] pt-6">
              <h3 className="mb-4 text-sm font-medium text-gray-700 dark:text-gray-300">Costos</h3>
        ...
        <div className="flex items-center justify-end gap-3 border-t border-gray-200 dark:border-[#2a2a2a] px-6 py-4">
          ...
          <Button color="primary" onPress={handleSaveProduct} className="bg-brand-600">
            Guardar Cambios
          </Button>
        </div>
      </div>
